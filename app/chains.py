...
class Chain:
    ...
    def write_mail(self, job, links):
        prompt_email = PromptTemplate.from_template(
            ...
            ### INSTRUCTION:
            You are Siri, a Product Developer with over three years of relevant experience 
        ...
        PowerPoint, Word, and Outlook enhances the ability to articulate objectives clearly and contribute as a valuable team player in a cross-cultural environment.
            Your job is to write a cold email to the client regarding the job mentioned above describing the capability of Siri 
            in fulfilling their needs.
            Also add the most relevant ones from the following links to showcase Siri's portfolio: {link_list}
            Remember you are Siri. 
